...
- [script2.js](script2.js) — the **only** script loaded. Contains app state, rendering, drag-drop, CSV/Excel import/export, weeks navigation. ~1545 lines.

> [!IMPORTANT]
> [script.js](script.js) is a **legacy file from before the weeks/library features were added**. It is *not* referenced from [index.html](index.html) (see [index.html:344](index.html#L344)). Do not edit `script.js` — edits go to [script2.js](script2.js).
...
Bottom of [script2.js:1540-1545](script2.js#L1540-L1545) — the script runs top-to-bottom on page load (no `DOMContentLoaded` listener; the `<script>` tag is at the end of `<body>`):
...
| Week tabs UI | [`renderWeeksTabs()`](script2.js#L771), [`addWeek()`](script2.js#L798), [`duplicateLastWeek()`](script2.js#L807) |
